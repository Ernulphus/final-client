...
const HomePageView = () => {
  ...
  return (
    <div className={classes.root}>
      ...
      <h3>Welcome to the CRUD Campus Manager. Click on links in the navigation bar to navigate.</h3>
      <p>Please enjoy the following unrelated information, courtesy of Wikipedia.</p>
      <p>
...
A 40,000-year-old tool found in Hohle Fels cave in south-western Germany, originally suggested to be a musical instrument or a religious object, was identified in 2020 as very likely to be a tool for making rope. It is a 20 cm (8 in) strip of mammoth ivory with four holes drilled through it. Each hole is lined with precisely cut spiral incisions. Plant fibres would have been fed through the holes and the tool twisted, creating strong ropes and twines. The spiral incisions would have tended to keep the fibres in place.[9] After this object was identified as a likely rope-making tool, other 15,000-year-old objects with holes with spiral incisions, made from reindeer antler, found previously in Cheddar Gorge, Somerset, England appear to have been used to manipulate ropes, for purposes still unclear, but now thought to be for making or manipulating ropes. They were originally named "batons", and thought possibly to have been carried as badges of rank.[9]

Impressions of cordage found on fired clay provide evidence of string and rope-making technology in Europe dating back 28,000 years.[10] Fossilized fragments of "probably two-ply laid rope of about 7 mm [0.28 in] diameter" were found in one of the caves at Lascaux, dating to approximately 15,000 BC.[11]
...
2D flight-throughs/sections
    ...
    File:Micro-CT Rope HighRes 2D Top 2050x2050.ogvPlay media
    File:Micro-CT 2D top view flight-through of a braided polymer climbing rope Zoom.ogvPlay media
    File:Micro-CT Rope HighRes 2D Right 2560x550 750f 25fps.ogvPlay media
    File:Micro-CT Rope HighRes 2D Rotation 2560x550 750f 25fps.ogvPlay media
...
3D flight-throughs/sections
    ...
    File:Micro-CT Rope HighRes 3D.ogvPlay media
...
If a load-bearing rope gets a sharp or sudden jolt or the rope shows signs of deteriorating, it is recommended that the rope be replaced immediately and should be discarded or only used for non-load-bearing tasks.[19][20]
...
Many types of filaments in ropes are weakened by corrosive liquids, solvents, and high temperatures. Such damage is particularly treacherous because it often invisible to the eye.[21]

Shock loading should be avoided with general use ropes, as it can damage them.[22] All ropes should be used within a safe working load, which is much less than their breaking strength.
...
See also
    ...
    Skipping rope, also known as Jump rope – Game in which one or more participants jump over a swung rope
...
McKie, Robin (1 August 2020). "Take a tusk, drill holes, weave a rope – and change the course of history". The Guardian. Article has photograph of the Hohle Fels rope-making tool.
...
Categories:
    ...
    RopesClimbing equipmentMountaineering equipmentPrimitive technology
...
Edit links
    ...
    This page was last edited on 18 October 2021, at 18:18 (UTC).
